...
@section('title', env('COLLEGE_NAME_SHORT') . ' - ' . env('COLLEGE_NAME'))
...
<style>
    ...
    .crausel-content {
        ...
        background: rgba(0, 0, 0, 0.6); /* Optional background for readability */
        color: white;
        padding: 20px;
        border-radius: 10px;
        max-width: 40%;
...
<div data-elementor-type="wp-post" data-elementor-id="304" class="elementor-304">
                ...
                <div class="elementor-element elementor-element-498494d elementor-widget elementor-widget-heading animated fadeInUp"
                    ...
                    <div class="elementor-widget-container">
                        <h1 class="elementor-heading-title elementor-size-default">                            
                            Fueling Growth Through Management and Technology
                        </h1>
                    </div>
                </div>                                
                        ...
                        <div class="elementor-element elementor-element-970618e elementor-mobile-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button"
                            ...
                            <div class="elementor-widget-container">
                                <div class="elementor-button-wrapper">
                                    <p>Promoting the best in management education technology and innovation.</p>
    ...
    <div id="fullscreenCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">                
                <img src="{{asset('images/students.jpg')}}" alt="Nature Image" height="100vh">
                <div class="crausel-content">
                    <h2 style="color: #fff; font-family:sans-serif;">First slide</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore laudantium a cupiditate sed enim necessitatibus labore, voluptatibus ducimus dolores itaque accusamus culpa architecto eos cumque. Ut neque quibusdam fuga non molestiae reiciendis voluptates harum nihil.</p>
                </div>
            </div>
            ...
            <div class="carousel-item">                
                <video autoplay loop muted>
                    <source src="images/college_video.mp4" type="video/mp4">
                </video>
                <div class="crausel-content">
                    <h2 style="color: #fff; font-family:sans-serif;">Second slide</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore laudantium a cupiditate sed enim necessitatibus labore, voluptatibus ducimus dolores itaque accusamus culpa architecto eos cumque. Ut neque quibusdam fuga non molestiae reiciendis voluptates harum nihil.</p>
                </div>
            </div>
            ...
            <!-- Another Image Slide -->
            <div class="carousel-item">                
                <img src="{{asset('images/student_girl.jpg')}}" alt="City Image">
                <div class="crausel-content">
                    <h2 style="color: #fff; font-family:sans-serif;">Third slide</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore laudantium a cupiditate sed enim necessitatibus labore, voluptatibus ducimus dolores itaque accusamus culpa architecto eos cumque. Ut neque quibusdam fuga non molestiae reiciendis voluptates harum nihil.</p>
                </div>
            </div>
        </div>
        ...
        <div class="e-con-inner">
            <div class="elementor-element elementor-element-6c90143 e-con-full e-flex e-con e-child animated fadeInLeft"
                ...
                <div class="elementor-element elementor-element-bfa63aa elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h3 class="elementor-heading-title elementor-size-default">Life on Campus</h3>
                    </div>
                </div>
                <div class="elementor-element elementor-element-b011bb9 elementor-widget elementor-widget-text-editor"
                    ...
                    <div class="elementor-widget-container">
                        <p>Here at {{env('COLLEGE_NAME_SHORT')}}, the student engagement is alive and thriving in campus life. We offer a stimulating environment for cooperation, creativity, and personal growth.</p>
                    </div>
                </div>
            </div>
            <div class="elementor-element elementor-element-8f2af22 e-con-full e-flex e-con e-child animated fadeInLeft"
                ...
                <div class="elementor-element elementor-element-341d01b elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h3 class="elementor-heading-title elementor-size-default">Supreme Faculty</h3>
                    </div>
                </div>
                <div class="elementor-element elementor-element-79d0de1 elementor-widget elementor-widget-text-editor"
                    ...
                    <div class="elementor-widget-container">
                        <p>Our faculty have been entrusted with the task of creating leaders of tomorrow in management and technology.</p>
                    </div>
                </div>
            </div>
            <div class="elementor-element elementor-element-0d6dc5d e-con-full e-flex e-con e-child"
                ...
                <div class="elementor-element elementor-element-1430bfb elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h3 class="elementor-heading-title elementor-size-default">Scholarship Assistance</h3>
                    </div>
                </div>
                <div class="elementor-element elementor-element-31dbb7f elementor-widget elementor-widget-text-editor"
                    ...
                    <div class="elementor-widget-container">
                        <p>At {{env('COLLEGE_NAME_SHORT')}}, we empower luminaries through merit scholarships and financial aid. With this commitment, we open the doors for those who suffer financial constraints, in welcoming an inclusive and equitable learning ambiance. </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="e-con-inner">
            ...
            <div class="elementor-element elementor-element-2d84654 e-con-full e-flex e-con e-child"
                ...
                <div class="elementor-element elementor-element-d0fe679 elementor-widget elementor-widget-heading animated fadeInUp"
                    ...
                    data-widget_type="heading.default">
                    <div class="elementor-widget-container">
                        <p class="elementor-heading-title elementor-size-default">Blending classical wisdom with modern technological progress for nurturing the leaders of tomorrow. </p>                        
                        <p class="elementor-heading-title elementor-size-default">{{env('COLLEGE_NAME_SHORT')}} is guided by a commitment to quality in education, research, and innovation while promoting leadership and entrepreneurship. Leaders at {{env('COLLEGE_NAME_SHORT')}} aim on creating empowered innovators of tomorrow via advanced pedagogies, collaborative industry partnerships, and broad international perspectives.</p>
                    </div>
                </div>                
        ...
        <div class="e-con-inner">
            ...
            <div class="elementor-element elementor-element-92bbd13 e-con-full e-flex e-con e-child"
                ...
                <div class="elementor-element elementor-element-067558b elementor-widget__width-initial elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h4 class="elementor-heading-title elementor-size-default">Placement Success Rate
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="elementor-element elementor-element-4e242b7 e-con-full e-flex e-con e-child"
                ...
                <div class="elementor-element elementor-element-e8d0ce6 elementor-widget__width-initial elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h4 class="elementor-heading-title elementor-size-default">Industry Collaborations</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="elementor-element elementor-element-a14fb6c e-con-full e-flex e-con e-child"
                ...
                <div class="elementor-element elementor-element-625febd elementor-widget__width-initial elementor-widget elementor-widget-counter"
                    ...
                    <div class="elementor-widget-container">
                        <div class="elementor-counter">
                            <div class="elementor-counter-number-wrapper">
                                <span class="elementor-counter-number-prefix"></span>                                
                                <span class="elementor-counter-number-suffix">40+</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="elementor-element elementor-element-223a61c elementor-widget__width-initial elementor-widget elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        <h4 class="elementor-heading-title elementor-size-default">Events Year-Round</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="e-con-inner row">
                        ...
                        <div class="elementor-element elementor-element-b126756 e-flex e-con-boxed e-con e-child"
                            ...
                            <div class="e-con-inner">
                                <div class="elementor-element elementor-element-f33ff06 elementor-widget elementor-widget-heading"
                                    ...
                                    <div class="elementor-widget-container">
                                        <p class="elementor-heading-title elementor-size-default">Overview of advanced business strategies, leadership skills, and innovative problem-solving skills. The program lays emphasis on experiential learning through case studies, live projects, and real-time research.</p>
                                    </div>
                                </div>
                    ...
                    <div class="elementor-element elementor-element-a87c91c e-con-full e-flex e-con e-child animated fadeInUp col-lg-6"
                        ...
                        <div class="elementor-element elementor-element-efe993f elementor-widget elementor-widget-heading"
                            ...
                            <div class="elementor-widget-container">                                
                                <h4 class="elementor-heading-title elementor-size-default">MCA (120 Seats)</h4>
                            </div>
                        </div>
                        ...
                        <div class="elementor-element elementor-element-a643fba e-flex e-con-boxed e-con e-child"
                            ...
                            <div class="e-con-inner">
                                <div class="elementor-element elementor-element-db90bdc elementor-widget elementor-widget-heading"
                                    ...
                                    <div class="elementor-widget-container">
                                        <p class="elementor-heading-title elementor-size-default">Advanced computing lessons with a focus on artificial intelligence, data analytics, and software development. The program aims to equip students with practical experience promoting expertise to thrive in the tech-driven era.</p>
                                    </div>
                                </div>
                ...
                <div class="e-con-inner row">
                    <div class="elementor-element elementor-element-907ff4b e-con-full e-flex e-con e-child animated fadeInUp col-lg-6"
                        ...
                        <div class="elementor-element elementor-element-8d28cd4 elementor-widget elementor-widget-heading"
                            ...
                            <div class="elementor-widget-container">
                                <h4 class="elementor-heading-title elementor-size-default">BBA (120 Seats)
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="elementor-element elementor-element-d91a31f e-flex e-con-boxed e-con e-child"
                            ...
                            <div class="e-con-inner">
                                <div class="elementor-element elementor-element-a04df3a elementor-widget elementor-widget-heading"
                                    ...
                                    <div class="elementor-widget-container">
                                        <p class="elementor-heading-title elementor-size-default">Study business administration with particular emphasis placed on strategic thinking as well as entrepreneurship and operational management. The curriculum incorporates leadership training and practical exposure through case studies and internships.</p>
                                    </div>
                                </div>
                        ...
                        <div class="elementor-element elementor-element-8b1438c e-flex e-con-boxed e-con e-child"
                            ...
                            <div class="e-con-inner">
                                <div class="elementor-element elementor-element-d5edd45 elementor-widget elementor-widget-heading"
                                    ...
                                    <div class="elementor-widget-container">
                                        <p class="elementor-heading-title elementor-size-default">Get equipped with knowledge of cloud computing, IoT, and blockchain. The program consciously is aimed at producing innovators and technical specialists by combining the theoretical approach with real-world applicability. </p>
                                    </div>
                                </div>
                            ...
                            <div class="elementor-testimonial-meta">
                                <div class="elementor-testimonial-meta-inner">
                                    <div class="elementor-testimonial-details">
                                        <div class="elementor-testimonial-name">-Aniruddh Wadhwa <br> (BBA Student 2nd Year)</div>                                        
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="elementor-widget-container">
                                <div class="elementor-icon-box-wrapper">
                                    ...
                                    <div class="elementor-icon-box-content">
                                        ...
                                        <p class="elementor-icon-box-description">For example {{env('COLLEGE_NAME_SHORT')}} has an awesome industry-aligned, cutting edge curriculum with technology like AI, data science, emerging fields to help students face real-life challenges of the real world and their forthcoming opportunities.</p>
                                    </div>
                                ...
                                <div class="elementor-icon-box-wrapper">
                                    ...
                                    <div class="elementor-icon-box-content">
                                        ...
                                        <p class="elementor-icon-box-description">
                                            The experiential learning model of our school allows students to be well grounded in real life projects, live case studies and industry internships to bridge theory and practice. 
                                        </p>
                            ...
                            <div class="elementor-widget-container">
                                <div class="elementor-icon-box-wrapper">
                                    ...
                                    <div class="elementor-icon-box-content">
                                        ...
                                        <div class="elementor-icon-box-title">
                                            <span>World-renowned Facilities for Research</span>
                                        </div>

                                        <p class="elementor-icon-box-description">
                                            {{env('COLLEGE_NAME_SHORT')}} exposes an entire landscape of AI and Integrated labs thoroughly geared to stimulate innovation, solve problems across clean energy to advanced computing, and social innovation.    
                                        </p>
                            ...
                            <div class="elementor-widget-container">
                                <div class="elementor-icon-box-wrapper">
                                    ...
                                    <div class="elementor-icon-box-content">
                                        ...
                                        <div class="elementor-icon-box-title">
                                            <span>International Projects and Cooperation</span>
                                        </div>

                                        <p class="elementor-icon-box-description">
                                            Our students also engage with international exposure by partnering with best global institutions in research collaborations, cultural exchange programs and corporate engagements.
                                        </p>
                            ...
                            <div class="elementor-widget-container">
                                <div class="elementor-icon-box-wrapper">
                                    ...
                                    <div class="elementor-icon-box-content">
                                        ...
                                        <p class="elementor-icon-box-description">
                                            Over 50 industry-linked collaborations with our students are able to leverage mentorship, workshops, guest lectures to make them job-ready through live projects of industry.
                                        </p>
                            ...
                            <div class="elementor-widget-container">
                                <div class="elementor-icon-box-wrapper">
                                    ...
                                    <div class="elementor-icon-box-content">
                                        ...
                                        <div class="elementor-icon-box-title">
                                            <span>Entrepreneurial Ecosystem</span>
                                        </div>

                                        <p class="elementor-icon-box-description">
                                            At {{env('COLLEGE_NAME_SHORT')}}, we encourage innovation through startup incubation centers that not only provide seed funding and mentorship but also nurture an environment to bring ideas to life  
                                        </p>
                    ...
                    <div class="elementor-widget-container">
                        <div class="elementor-icon-box-wrapper">
                            ...
                            <div class="elementor-icon-box-content">
                                ...
                                <p class="elementor-icon-box-description">At {{env('COLLEGE_NAME_SHORT')}}, we aim to transform India into a global knowledge superpower through cutting-edge education, research, and innovation. We are committed to preparing future leaders who will drive positive change in society and the world.</p>
                    ...
                    <div class="elementor-widget-container">
                        <div class="elementor-icon-box-wrapper">
                            ...
                            <div class="elementor-icon-box-content">
                                ...
                                <p class="elementor-icon-box-description">We focus on providing a dynamic learning environment, fostering creativity, critical thinking, and practical expertise. Through advanced technology, interdisciplinary research, and strong industry ties, we prepare students to become thought leaders and problem-solvers.</p>
                    ...
                    <div class="elementor-widget-container">
                        <div class="elementor-icon-box-wrapper">
                            ...
                            <div class="elementor-icon-box-content">
                                ...
                                <p class="elementor-icon-box-description">
                                    Confirm your spot, and get ready for a great school experience.</p>
                ...
                <div class="e-con-inner">
                    ...
                    <div class="elementor-element elementor-element-620f817 e-con-full e-flex e-con e-child"
                        ...
                        <div class="elementor-element elementor-element-8a8a63b elementor-widget elementor-widget-text-editor"
                            ...
                            <div class="elementor-widget-container">
                                <p>You can feel the ambience of our 6.81 acres campus in Greater Noida which is designed for higher learning as well holistic development. Take advantage of:</p>
                            </div>
                        </div>
                                        ...
                                        <div class="ekit-wid-con">
                                            <div class="ekit-heading elementskit-section-title-wraper text_left   ekit_heading_tablet-   ekit_heading_mobile-">
                                                ...
                                                <div class="ekit-heading__description">
                                                    ...
                                                    <ul style="color: #fff;">
                                                        <li>Newest laboratories and innovation campuses</li>
                                                        <li>The fully equipped library with digital access</li>
                                                        <li>Student clubs & extra-curricular activities</li>
                                                        <li>Good accommodation on campus with all the essentials that a student require</li>
                                                        <li>Meetings with industry, workshops</li>
                                                    </ul>                                                    
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="e-con-inner">
            <div class="elementor-element elementor-element-5a80b44 e-con-full e-flex e-con e-child" style="width: 75%;"
                ...
                <div class="elementor-element elementor-element-0629977 elementor-invisible elementor-widget elementor-widget-heading"
                    ...
                    data-widget_type="heading.default">
                    <div class="elementor-widget-container">
                        <h2 class="elementor-heading-title elementor-size-default">Facing Limited Opportunities of Innovation? <br> {{env('COLLEGE_NAME_SHORT')}} Drive Excellence in Management and Technology!</h2>
                    </div>
                </div>
