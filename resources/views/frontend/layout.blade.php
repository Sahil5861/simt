...
<html lang="en">
    <head>
        ...
        <meta property="og:title" content="{{ $current_blog->meta_title ?? 'Default Title' }}">
    ...
    <div class="social-sidebar">
        <ul>
            <li title="Facebook"><a href="https://www.facebook.com/people/Sitasrm-Institute-of-Management-and-Technology/61576331637810/" class="e-s-i"><i class="fa fa-facebook"></i></a></li>
            <li title="Twitter"><a href="https://x.com/simt_grnoida?t=8wTK7NZEpqvIycCI7zca1g&s=08" class="e-s-i"><i class="fab fa-x-twitter"></i></a></li>
            <li title="Linkedin"><a href="https://www.linkedin.com/company/sitasrm-institute-of-management-and-technology/" class="e-s-i"><i class="fab fa-linkedin"></i></a></li>
            <li title="Instagram"><a href="https://www.instagram.com/simt.grnoida?igsh=bGt4bHlsOWJ1YTMx" class="e-s-i"><i class="fa fa-instagram"></i></a></li>
