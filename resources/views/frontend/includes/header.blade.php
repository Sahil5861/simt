<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <div id="mobile-menus" class="mobile-menu flex flex-col bg-[#a51c30] p-4 space-y-2 transition-all fixed h-[95vh] z-[9999] w-[300px] right-0 pt-10 lg:hidden" style="background-color: var(--e-global-color-accent);">
        <ul>
            <li><a href="{{ route('home') }}" class="{{request()->routeIs('home') ? 'active' : ''}}">Home</a></li>
            <li><a href="{{ route('about') }}" class="{{request()->routeIs('about') ? 'active' : ''}}">About {{env('COLLEGE_NAME_SHORT')}}</a></li>
            {{-- <li style="position:relative"><a href="#" class="ekit-menu-nav-link ekit-menu-dropdown-toggle {{request()->routeIs('courses') ? 'active' : ''}}">Programmes                
                </a>
            ...
            <li class="nav-item dropdown">
                ...
                {{-- <ul class="dropdown-menu" aria-labelledby="programsDropdown">
                  <li><a class="dropdown-item text-dark" href="#">B Tech</a></li>
                  <li><a class="dropdown-item text-dark" href="#">M Tech</a></li>
                  <li><a class="dropdown-item text-dark" href="#">PhD</a></li>
                </ul> --}}

                <ul class="dropdown-menu" aria-labelledby="admissionsDropdown" style="width:max-content; flex-direction:column; align-items:flex-start; overflow-y:auto; height:380px;">
